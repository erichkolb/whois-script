...
if(isset($_POST['submit']))
{
	...
	$medrec3 = mres(trim(htmlspecialchars_decode($_POST["medrec3"])));
	...
	if($_POST["medrec3_status"]=="on") 
		$medrec3_status = 1;
	else
		$medrec3_status = 0;
	
	update_ads($medrec1,$medrec1_status,$medrec2,$medrec2_status,$medrec3,$medrec3_status);
}
						...
						<div class="col-lg-12">
							...
							<form action="ads.php" method="post">
								<div class="row">
									<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
										<div class="form-group">
											<label class="text-center"><b>Leaderboard Ad - 728x90 </b></label><br />
										</div>
									</div>
									<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
										<div class="form-group">
									...
									<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
									    <div class="form-group">
											...
											$row=mysql_fetch_array(mysqlQuery("SELECT medrec1_status,medrec2_status,medrec3_status FROM ads"));
											
											$medrec1_status=$row['medrec1_status'];
											
											$medrec2_status=$row['medrec2_status'];
											
											$medrec3_status=$row['medrec3_status'];
								...
								<div class="row">
									<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
										<div class="form-group">
											<label class="text-center"><b>Large Rectangle Ad - 336x280</b></label><br />
										</div>
									</div>
									<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
										<div class="form-group">
								...
								<div class="row">
									...
									<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
										<div class="form-group">
											<textarea class="form-control push-left min-height" rows="1" cols="1" name="medrec3"><?php echo (show_med_rec3_ad())?>
											</textarea>
										</div>
									</div>
									<div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
										<div class="form-group">
											...
											?>
											<div class="form-group">
												<label class="text-center"><label class="text-center"><input class="my_checkbox" type="checkbox" name="medrec3_status" checked="checked" /></label></label>
											</div>
											<?php
											}
											else
											...
											?>
											<div class="form-group">
												<label class="text-center"><input class="my_checkbox" type="checkbox" name="medrec3_status" /></label>
											</div>
											<?php 
											} 
											?>
