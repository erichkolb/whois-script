...
function loadData(page,search,type,order,bydefault)
{
	...
	$('#results').html("<img style='display:block;margin: auto auto; margin-top:250px; margin-bottom:257px;' src='<?php echo rootpath(); ?>/admin/style/images/ajax_loader.GIF'/>").fadeIn('fast');
	$.ajax
	({
		type: "POST",
		url: "load_data.php",
