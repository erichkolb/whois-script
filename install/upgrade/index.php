...
<html lang="en">
	...
	<head>
		<meta charset="utf-8">
		<title>WhoIs Search Upgrade Wizard</title>
							...
							else if($version=="")
							{
								...
								<div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
									<div class="alert alert-danger">
										<i class="fa fa-check-square"></i> 
											WhoIs Search Script 1.0 Is Not Installed.
									</div>
